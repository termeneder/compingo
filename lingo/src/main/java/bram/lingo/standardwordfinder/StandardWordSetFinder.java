...
public class StandardWordSetFinder {
	...
	public StandardWordSetFinder(WordSetValuator valuator, int amountOfWordsInStandardSet, SortOrder order) {
		c_valuator = valuator;
		c_amountOfWordsInStandardSet = amountOfWordsInStandardSet;
		c_order = order;
	}
	
	public StandardWordSetFinder(WordSetValuator valuator, int amountOfWordsInStandardSet) {
		c_valuator = valuator;
		c_amountOfWordsInStandardSet = amountOfWordsInStandardSet;
